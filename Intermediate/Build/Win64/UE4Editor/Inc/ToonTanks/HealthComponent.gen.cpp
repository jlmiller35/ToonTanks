...
// End Cross Module References
	DEFINE_FUNCTION(UHealthComponent::execTakeDamage)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->TakeDamage(Z_Param_DamagedActor,Z_Param_Damage,Z_Param_DamageType,Z_Param_InstigatedBy,Z_Param_DamageActor);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHealthComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHealthComponent_TakeDamage, "TakeDamage" }, // 740309573
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UHealthComponent, 840972237);
